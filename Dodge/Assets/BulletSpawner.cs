...
public class BulletSpawner : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        target = FindAnyObjectByType<PlayerController>().transform; // PlayerController 컴포넌트를 가진 게임 오브젝트르 찾아 조준 대상으로 설정
    ...
    void Update()
    {
        ...
        {
            timeAfterSpawn = 0f; // 누적된 시간을 리세셋

            GameObject bullet //bulletPrefab 복제본을 transform.position 위치와 transform.rotation 회전으로 생성
